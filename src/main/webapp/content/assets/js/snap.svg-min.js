...
function(a, b) {
    ...
    return d.plugin(function(d, e, f, g, h) {
        function i(a, b) {
            if (null == b) {
                ...
                b = d._.rgTransform.test(b) ? o(b).replace(/\.{3}|\u2026/g, a._.transform || E) : d._.svgTransform2string(b),
        ...
        m.transform = function(a) {
            ...
            return a instanceof d.Matrix ? (this.matrix = a,
            this._.transform = a.toTransformString()) : i(this, a),
        ...
        ,
        m.select = function(a) {
            return a = o(a).replace(/([^\\]):/g, "$1\\:"),
            u(this.node.querySelector(a))
        }
        ,
        ...
        m.removeData = function(a) {
            return null == a ? x[this.id] = {} : x[this.id] && delete x[this.id][a],
            this
        }
        ,
    ...
    d.plugin(function(c, d, e, f) {
        ...
        g.svg = function(a, b, c, d, e, f, g, i) {
            var j = {};
            return h(a, "object") && null == b ? j = a : (null != a && (j.x = a),
            null != b && (j.y = b),
            null != c && (j.width = c),
            null != d && (j.height = d),
            null != e && null != f && null != g && null != i && (j.viewBox = [e, f, g, i])),
            this.el("svg", j)
        }
        ,
        g.mask = function(a) {
        ...
        function() {
            ...
            g.clear = function() {
                for (var a, b = this.node.firstChild; b; )
                    a = b.nextSibling,
                    "defs" != b.tagName ? b.parentNode.removeChild(b) : g.clear.call({
                        node: b
                    }),
                    b = a
            }
    ...
    d.plugin(function(a, c) {
        ...
        function e(b, c, e) {
            ...
            for (var f, g, h, i, l = Math.max(b.length, c.length), m = [], n = [], o = 0; l > o; o++) {
                ...
                n[o] = [],
                f = 0,
                g = Math.max(h.length, i.length); g > f; f++)
                    f in h && (m[o][f] = h[f]),
                    f in i && (n[o][f] = i[f])
            }
            return {
        ...
        b.on("snap.util.equal", function(b, c) {
            ...
            if ("points" == b)
                return d = p(r).split(a._.separator),
    ...
    d.plugin(function(a, b) {
        ...
        b.prototype.getAlign = function(a, b) {
            null == b && d(a, "string") && (b = a,
            a = null),
            a = a || this.paper;
            var g = a.getBBox ? a.getBBox() : c(a)
              , h = this.getBBox()
              , i = {};
            switch (b = b && b.match(e),
